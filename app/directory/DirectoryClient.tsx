            ...
            return (
              ...
              >
                ...
                <div className="w-12 h-12 bg-teal rounded-lg flex items-center justify-center text-white font-serif font-bold shrink-0">
                  {company.logoUrl ? <img src={company.logoUrl} alt="Logo" className="w-full h-full object-cover rounded-lg" /> : company.logo || company.name.substring(0, 2).toUpperCase()}
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted flex items-center gap-1 mb-2">
                    <MapPin size={12} /> {company.location || "Global"}
                  </div>
